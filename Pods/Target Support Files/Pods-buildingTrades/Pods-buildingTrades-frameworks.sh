...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/PhotoEditorSDK/pesdk-ios-build-8.1.3/PhotoEditorSDK.framework"
  install_dsym "${PODS_ROOT}/PhotoEditorSDK/pesdk-ios-build-8.1.3/PhotoEditorSDK.framework.dSYM"
